...
case class AmendDiscrepancyTransportDocPage(submissionId: String) extends QuestionPage[DocumentDetails] {

  override def path: JsPath = JsPath \ "amend" \ submissionId \ toString

  override def toString: String = "discrepancyTransportDoc"
}
